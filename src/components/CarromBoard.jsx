...
const CarromBoard = () => {
  ...
  return (
    ...
    <div className='relative p-6 bg-[#2d1b19] rounded-[2rem] shadow-2xl border-b-8 border-[#1a0f0e]'>
        <div ref={boardRef} className=' relative w-[600px] h-[600px] bg-[#dfbb9d] z-0' >
            ...
            {/* </div> */}
            <div className='absolute top-8 left-8 w-14 h-14 bg-zinc-900 rounded-full shadow-[inset_0_8px_15px_rgba(0,0,0,1)] border-2 border-white/5 z-50 '/>
            <div className='absolute top-8 right-8 w-14 h-14 bg-zinc-900 rounded-full shadow-[inset_0_8px_15px_rgba(0,0,0,1)] border-2 border-white/5 z-50 '/>
            <div className='absolute bottom-8 left-8 w-14 h-14 bg-zinc-900 rounded-full shadow-[inset_0_8px_15px_rgba(0,0,0,1)] border-2 border-white/5 z-50 '/>
            <div className='absolute bottom-8 right-8 w-14 h-14 bg-zinc-900 rounded-full shadow-[inset_0_8px_15px_rgba(0,0,0,1)] border-2 border-white/5 z-50 '/>
