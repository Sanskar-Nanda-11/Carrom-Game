    ...
    return (
        <>
                ...
                <div className=' flex justify-between items-end w-full max-w[700px] mb-6'>
                    ...
                    <div className='flex items-center gap-4 bg-white/5 border border-white/10 px-6 py-2 rounded-2xl backdrop-blur-md'>
                        <div className='text-center'>
                            <span className='block text-[10px] text-zinc-500 font-bold uppercase'> P1 </span>
                            <span className='text-xl font-mono text-amber-500'> 00 </span>
                        </div>
                        <div className='h-6 w-[1px] bg-white/20 ' />
                        <div className='text-center'>
                            <span className='block text-[10px] text-zinc-500 font-bold uppercase'> P2 </span>
            ...
            <div className='relative p-6 bg-[#2d1b19] rounded-[2rem] shadow-2xl border-b-8 border-[#1a0f0e]'>
                <div ref={boardRef} className=' relative w-[600px] h-[600px] bg-[#dfbb9d] rounded-sm overflow-hidden' >
